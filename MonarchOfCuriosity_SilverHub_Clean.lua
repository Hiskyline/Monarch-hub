...
--[[
    Cleaned & rebranded for "Monarch of Curiosity".
    This build removes discord popups and clipboard calls.
]]
if not getgenv then getgenv = function() return _G end end
if not getgenv().toclipboard then
    getgenv().toclipboard = function(...) end
end
...
function LoadSettings()
	if readfile and writefile and isfile and isfolder then
		if not isfolder("Monarch of Curiosity Hub Premium Scripts") then
			makefolder("Monarch of Curiosity Hub Premium Scripts")
		end
		if not isfolder("Monarch of Curiosity Hub Premium Scripts/Blox Fruits/") then
			makefolder("Monarch of Curiosity Hub Premium Scripts/Blox Fruits/")
		end
		if not isfile("Monarch of Curiosity Hub Premium Scripts/Blox Fruits/" .. game.Players.LocalPlayer.Name .. ".json") then
			writefile("Monarch of Curiosity Hub Premium Scripts/Blox Fruits/" .. game.Players.LocalPlayer.Name .. ".json", game:GetService("HttpService"):JSONEncode(_G.Settings))
		else
			local Decode = game:GetService("HttpService"):JSONDecode(readfile("Monarch of Curiosity Hub Premium Scripts/Blox Fruits/" .. game.Players.LocalPlayer.Name .. ".json"))
...
function SaveSettings()
	if readfile and writefile and isfile and isfolder then
		if not isfile("Monarch of Curiosity Hub Premium Scripts/Blox Fruits/" .. game.Players.LocalPlayer.Name .. ".json") then
			...
			writefile("Monarch of Curiosity Hub Premium Scripts/Blox Fruits/" .. game.Players.LocalPlayer.Name .. ".json", game:GetService("HttpService"):JSONEncode(Array))
		end
	else
		return warn("Status : Undetected Executor")
	end
...
if QuestC.Visible == true then
						...
						local Library = loadstring(game:HttpGet("https://raw.githubusercontent.com/minhhau207/Monarch of CuriosityHub/main/obfuscated-3788.lua"))()
